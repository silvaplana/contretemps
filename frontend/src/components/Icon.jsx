...
const paths = {
  ...
  // Groupe WhatsApp miroir (Admin > Conversations, voir spec/SPEC.md §6.9) :
  // bulle de discussion arrondie avec une queue, pas le logo de marque
  // exact — juste assez reconnaissable, dans le même style que les autres
  // icônes (traits fins). Le statut lié/pas lié se lit à la couleur (voir
  // .whatsapp-statut dans App.css), pas au détail du tracé.
  whatsapp: 'M12 3a9 9 0 1 0-7.5 13.9L3 21l4.3-1.4A9 9 0 0 0 12 3Z',
}
